		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ns10demoapp10tbp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ns10demoapp10tbp-display": {
								"semanticObject": "ns10demoapp10tbp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns10.demoapp10tbp",
									"url": sap.ui.require.toUrl("ns10/demoapp10tbp")
								}
							}
						}
					}
